...
module T = struct
  ...
  and array_kind = Type_based_optimization.array_kind =
      Pgenarray | Paddrarray | Pintarray | Pfloatarray

  and value_kind = Type_based_optimization.value_kind =
  ...
  and bigarray_kind = Type_based_optimization.bigarray_kind =
      Pbigarray_unknown
  ...
  and bigarray_layout = Type_based_optimization.bigarray_layout =
